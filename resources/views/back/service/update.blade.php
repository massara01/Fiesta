              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="POST" action="{{route('update.admin.services',$service->id)}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-sm-4 mt-3">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ $service->name }}" name="name" id="basic-default-name" />
                                @error('name')
                            ...
                            <div class="col-sm-4 mt-3">
                                <input type="text" class="form-control @error('price') is-invalid @enderror" value="{{$service->price}}""  name="price" id="basic-default-name" />
                                @error('price')
                                    <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                <input type="text" class="form-control @error('adress') is-invalid @enderror" value="{{$service->adress}}" name="adress" id="basic-default-company"/>
                                @error('adress')
                                    <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                <select class="form-select @error('typename') is-invalid @enderror" name="typename" id="exampleFormControlSelect1" >
                                    <option selected disabled>Choisir un type de service</option>
                                    @foreach($typesS as $p)
                                        <option value="{{$p->typename}}" {{$p->typename == $service->typename ? 'selected':''}}>{{$p->typename}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-4 mt-3">
                                    <div class="file-upload">
                                        ...
                                        <div class="file-select-name">{{ $service->image }}</div> 
                                        <input type="file" value="{{ $service->image }}" name="image" id="file-upload-input">
                                        </div>
                                    </div>
                                    @error('image')
                            ...
                            <div class="col-sm-4 mt-3">
                                    <div class="file-upload">
                                        ...
                                        <div class="file-select-name1">{{ $service->image360 }}</div> 
                                        <input type="file" value="{{ $service->image360 }}" name="image" id="file-upload-input1">
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-10 mt-3">
                                <select class="form-select @error('id_user') is-invalid @enderror" name="id_user" id="exampleFormControlSelect1" >
                                    <option selected disabled>Choisir un prestataire</option>
                                    @foreach($users as $user)
                                        <option value="{{$user->id}}" {{$user->id == $service->id_user ? 'selected':'' }}>{{$user->nom}} {{$user->prenom }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-10 mt-3">
                                <textarea style="height: 150px" id="basic-default-email" class="form-control @error('description') is-invalid @enderror" name="description" class="form-control">{{ $service->description }}</textarea>
                                @error('description')
                                    <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
